  ...
  return (
    <div className="relative font-sans antialiased min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 bg-background">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-accent/5 blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <BrowserRouter>
        <main className="flex-1 container mx-auto px-4 sm:px-6 py-8 flex flex-col items-center justify-center">
          ...
          <Suspense fallback={<div className="flex items-center justify-center h-40">
